        ...
        <footer className="mt-8 lg:mt-14 mb-6">
          <div className="flex flex-col md:flex-row mx-4">
                ...
                >
                  <div className="p-2 mr-4 my-4 rounded-full bg-gradient-to-t from-blue-600 to-cyan-300">
                    <svg
                      ...
                      stroke-width="0"
                      viewBox="0 0 320 512"
                      className="text-white h-4 md:h-6 w-4 md:w-6"
                      height="1em"
                      width="1em"
            ...
            <div className="flex-1 flex flex-col md:flex-row">
              <div className="flex-1">
                <h4 className="text-base md:text-xl font-bold">Programs</h4>
              ...
              <div className="flex-1 ml-0 mt-6 md:ml-20">
                <h4 className="text-base md:text-xl font-bold">Pages</h4>
                <ul className="text-slate-600 mt-4">
                  <li className="text-sm md:text-base my-2">
                    <Link
                      href={"#"}
